...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editloading WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukloading.php" class="edit_btn" >Edit Soalan Masalah loading yang lama</a>
<!---------------PHP code-------------->
...
<?php endif ?>
<!-----------end of PHP code----------->
<p><b>Masalah komputer loading mengambil masa yang lama untuk siap loading sesuatu page atau website</b></p>

<?php $results = mysqli_query($db, "SELECT * FROM editloading"); ?>
<table>
	<thead>
		<tr>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="loading_admin.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del11=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<form method="post" action="bantuan_admin.php" >
	...
	<div class="input-group">
		...
		<?php if ($update == false): ?>
			<button class="btn" type="submit" name="save11" style="background: #556B2F;" >Simpan</button>
		<?php else: ?>
			<button class="btn" type="submit" name="update11" >Kemaskini</button>
		<?php endif ?>
	</div>
</form>
<div class="btn_back">
		<button><a href="rangkaian_admin.php"><img src="img/back.png" width="35" height="30" align="right"></a></button>
	</div>
</div>
</div>	
</body>
