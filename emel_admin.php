...
<!--data-->
<div id="data"><br>
<center><h3>Emel</h3></center>
<!--btn-->
<div class="container">
	<form action="attachment_admin.php" method="post">
	<button class="btn btn1" type="submit" name="button">Fail yang diterima daripada attachment hilang selepas di simpan</button>
	</form>
	</div>
	<div class="container">
	<form action="battachment_admin.php" method="post">
	<button class="btn btn2" type="submit" name="button">Masalah tidak boleh buka attachment</button>
	</form>
	</div>
</div>
