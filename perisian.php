...
(FAQ)</h2></center>
									<!-----masalah autoshutdown----->
<!-- Trigger/Open The Modal -->
<button id="myBtn">Masalah komputer autoshutdown</button><br>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-header">
	...
	<p>Soalan : Masalah komputer autoshutdown.</p>
	<p>Soalan lebih kurang sama</p>
	<?php $results = mysqli_query($db, "SELECT * FROM tajukautoshutdown"); ?>
	...
	<p>ii)Tutup PC selama lebih kurang 10 minit dan buka kembali.</p>
	<p>iii)Kipas penyejuk komputer tidak berfungsi.</p>
	<p>iv)Jika terdapat “pop up” menyatakan virus auto shut down, cuba scan guna antivirus</p>
	</div>
	<div id="page"><h3></h3>
	<div class="modal-footer">
	<p>cara terkini menyelesaikan masalah</p>
<?php $results = mysqli_query($db, "SELECT * FROM editautoshutdown"); ?>
				<table table-layout="fixed" width="90%">
					<thead>
						<tr><th></th>
							<th></th>
					...
					while ($row = mysqli_fetch_array($results)) { ?>
						...
						$no++;} ?>
                                    ...
                                    <!-----masalah window----->
<!-- Trigger/Open The Modal -->
<button id="komputer">Masalah komputer tidak boleh ke window</button>
...
<div id="myModal1" class="modal1">
  ...
  <div class="modal-header">
    ...
    <p>Soalan-Soalan Yang Sering Ditanya <br>(FAQ)</p>
	<p>Soalan : Masalah komputer tidak boleh masuk ke window</p>
	<p>Soalan lebih kurang sama</p>
	<?php $results = mysqli_query($db, "SELECT * FROM tajukwindow"); ?>
					<table table-layout="fixed" width="90%">
					<thead>
						<tr><th></th>
							<th></th>
	...
	<div class="modal-body">
	<p>Jawapan</p>
	<p>i)Pastikan floppy disk tiada dalam floppy drive</p>
	</div>
	<div id="page"><h3></h3>
	<div class="modal-footer">
	<p>Cara Terkini Menyelesaikan Masalah</p>
