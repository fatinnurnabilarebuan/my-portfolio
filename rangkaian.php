...
<button id="myBtn">Masalah saya tidak boleh melayari internet</button>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-header">
	...
	<p>Soalan : Masalah saya tidak boleh melayari internet</p>
	<p>Soalan lebih kurang sama</p>
	<?php $results = mysqli_query($db, "SELECT * FROM tajukinternet"); ?>
	...
	<p>Jawapan</p>
	<p>i)Check network terlebih dahulu.</p>
	<p>ii)Check cable network, plug</p>
	<p>iii)Cuba ping kepada server dan tengok akan ia menerima reply yang sempurna atau tidak</p>
	</div>
	<div id="page"><h3></h3>
	<div class="modal-footer">
	<p>Cara Terkini Menyelesaikan Masalah</p>
<?php $results = mysqli_query($db, "SELECT * FROM editinternet"); ?>
				<table table-layout="fixed" width="90%">
					<thead>
						<tr><th></th>
							<th></th>
					...
					while ($row = mysqli_fetch_array($results)) { ?>
						...
						$no++;
                                    ...
                                    <!-----masalah loading----->
<!-- Trigger/Open The Modal -->
<button id="komputer">Masalah komputer loading mengambil masa yang lama untuk siap loading sesuatu page atau website</button>
...
<div id="myModal1" class="modal1">
  ...
  <div class="modal-header">
	...
	<p>Soalan lebih kurang sama</p>
	<?php $results = mysqli_query($db, "SELECT * FROM tajukloading"); ?>
					<table table-layout="fixed" width="90%">
					<thead>
						<tr><th></th>
							<th></th>
