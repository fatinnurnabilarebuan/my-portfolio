...
function test(){
	...
	echo "<p>Soalan : Masalah CD ROM tidak berfungsi (tidak dapat membaca cd)</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Pastikan cd tidak rosak/bercalar.</p>";
	echo "<p>ii)Pastikan CD yang digunakan adalah drive CD, bukan DVD</p>";
}
