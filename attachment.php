...
function test(){
	...
	echo "<p>Soalan : Fail yang diterima daripada attachment, hilang selepas di simpan.</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Pastikan fail yang diterima disimpan (save) dalam cakera keras (desktop) terlebih dahulu sebelum membuat pindaan (edit)</p>";
}
