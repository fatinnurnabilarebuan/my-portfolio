...
include('tajuk_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM tajukprinter WHERE id=$id");
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="tajukprinter.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="tajuk_admin.php?del=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<div class="btn_back">
		<button><a href="printer_admin.php"><img src="img/back.png" width="35" height="30" align="right"></a></button>
	</div>
</div>
</body>
</html>