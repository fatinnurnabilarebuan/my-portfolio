...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editusb WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukusb.php" class="edit_btn" >Edit Soalan Masalah usb</a>
<!---------------PHP code-------------->
...
<?php endif ?>
<!-----------end of PHP code----------->
<p><b>Masalah USB tidak dapat berfungsi</b></p>
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="usb_admin.php?edit4=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del4=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<form method="post" action="bantuan_admin.php" >
	...
	<div class="input-group">
		...
		<?php if ($update == false): ?>
			<button class="btn" type="submit" name="save4" style="background: #556B2F;" >Simpan</button>
		<?php else: ?>
			<button class="btn" type="submit" name="update4" >Kemaskini</button>
		<?php endif ?>
	</div>
</form>
<div class="btn_back">
