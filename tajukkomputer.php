...
include('tajuk_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM tajukkomputer WHERE id=$id");
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="tajukkomputer.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="tajuk_admin.php?del1=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<div class="btn_back">
		<button><a href="komputer_admin.php"><img src="img/back.png" width="35" height="30" align="right"></a></button>
	</div>
</div>
</body>
</html>