...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editattachment1 WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukattachment.php" class="edit_btn" >Edit Soalan Masalah attachment</a>
<!---------------PHP code-------------->
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="attachment_admin.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del8=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
