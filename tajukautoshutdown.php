...
include('tajuk_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM tajukautoshutdown WHERE id=$id");
...
<?php endif ?>
<!-----------end of PHP code----------->
<p><b>Masalah komputer autoshutdown</b></p>
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="tajukautoshutdown.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="tajuk_admin.php?del5=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<form method="post" action="tajuk_admin.php" >
	...
	<div class="input-group">
		...
		<?php if ($update == false): ?>
			<button class="btn" type="submit" name="save5" style="background: #556B2F;" >Simpan</button>
		<?php else: ?>
			<button class="btn" type="submit" name="update5" >Kemaskini</button>
		<?php endif ?>
	</div>
</form>
<div class="btn_back">
		<button><a href="autoshutdown_admin.php"><img src="img/back.png" width="35" height="30" align="right"></a></button>
	</div>
</div>
</body>
</html>