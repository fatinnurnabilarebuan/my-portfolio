...
function test(){
	...
	echo "<p>Soalan : Masalah komputer menjadi Blue Screen.</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Matikan computer tersebut selama 10 minit supaya ia dapat reset atau sejukkan perkakasan dalaman computer</p>";
	echo "<p>ii) Lihat berdasarkan kepada error keluar, hubungi help desk untuk tindakan selanjutnya</p>";
}
...
<div class="btn_back">
<button><a href="peralatan.php"><img src="img/back.png" width="35" height="30"></a></button>
</body>
<style>
body {
	font-family: calibri;
