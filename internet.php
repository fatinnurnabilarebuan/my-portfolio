...
function test(){
	...
	echo "<p>Soalan : Masalah saya tidak boleh melayari internet</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Check network terlebih dahulu.</p>";
	echo "<p>ii)Check cable network, plug</p>";
	echo "<p>iii)Cuba ping kepada server dan tengok akan ia menerima reply yang sempurna atau tidak</p>";
}
