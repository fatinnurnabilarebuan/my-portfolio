...
function test(){
	...
	echo "<p>Soalan : Printer gagal berfungsi dengan sempurna. (tidak boleh print)</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Check cable power dan usb</p>";
	echo "<p>ii)Check toner, kertas.</p>";
	echo "<p>iii)Check error mesej</p>";
}
