...
function test(){
	...
	echo "<p>Soalan : Masalah komputer sering di serang virus.</p>";
	echo "<p>Jawapan</p>";
	echo "<p>i)Pastikan tiada disket dalam floppy drive.</p>";
	echo "<p>ii)Jangan memuat turun (download) data daripada internet tanpa kebenaran.</p>";
	echo "<p>iii)Jangan melayari laman web yang tidak dibenarkan.</p>";
	echo "<p>iv)Jangan buka email yang tidak dikenali.</p>";
}
...
<div class="btn_back">
<button><a href="virus.php"><img src="img/back.png" width="35" height="30"></a></button>
</body>
<style>
body {
	font-family: calibri;
