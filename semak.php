...
<div class="header">
  <a href="#default" class="logo"><img src="img/LOGO.jpg" width="250" height="150"></a>
...
<body>
		...
		<br />
			...
			<?php $results = mysqli_query($db, "SELECT * FROM logpelapor"); ?>
				<table bgcolor="white" table-layout="fixed" width="90%" method="post" action="semakaduan.php">
					<thead>
						<tr><th>No</th>
							<th>Tarikh</th>
							<th>Masa</th>
