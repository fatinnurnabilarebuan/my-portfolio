...
<!--data-->
<div id="data"><br>
<center><h3>Perisian</h3></center>
<div class="container">
	<form action="autoshutdown_admin.php" method="post">
	<button class="btn btn1" type="submit" name="button">Masalah komputer autoshutdown</button>
	</form>
	</div>
	<div class="container">
	<form action="window_admin.php" method="post">
	<button class="btn btn2" type="submit" name="button">Masalah komputer tidak boleh ke window</button>
	</form>
	</div>
</div>
