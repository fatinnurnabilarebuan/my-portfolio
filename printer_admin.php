...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editprinter WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukprinter.php" class="edit_btn" >Edit Soalan Masalah Printer</a>
<!---------------Edit masalah baru-------------->
<!---------------PHP code-------------->
...
<?php endif ?>
<!-----------end of PHP code----------->
<p><b>Printer gagal berfungsi dengan sempurna (tidak boleh print)</b></p>
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="printer_admin.php?edit=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<form method="post" action="bantuan_admin.php" >
	...
	<div class="input-group">
		...
		<?php if ($update == false): ?>
			<button class="btn" type="submit" name="save" style="background: #556B2F;" >Simpan</button>
		<?php else: ?>
			<button class="btn" type="submit" name="update" >Kemaskini</button>
		<?php endif ?>
	</div>
</form>
<div class="btn_back">
		<button><a href="peralatan_admin.php"><img src="img/back.png" width="35" height="30" align="right"></a></button>
	</div>
</div>
</body>
</html>