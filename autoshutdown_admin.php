...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editautoshutdown WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukautoshutdown.php" class="edit_btn" >Edit Soalan Masalah autoshutdown</a>
<!---------------PHP code-------------->
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="autoshutdown_admin.php?edit5=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del5=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
