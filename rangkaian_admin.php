...
<!--data-->
<div id="data"><br>
<center><h3>Rangkaian</h3></center>
<div class="container">
	<form action="internet_admin.php" method="post">
	<button class="btn btn1" type="submit" name="button">Masalah saya tidak boleh melayari internet</button>
	</form>
	</div>
	<div class="container">
	<form action="loading_admin.php" method="post">
	<button class="btn btn2" type="submit" name="button">Masalah komputer loading mengambil <br> masa yang lama untuk siap <br> loading sesuatu page atau website</button>
	</form>
	</div>
</div>
