...
include('bantuan_admin.php');
		...
		$array 	= "";
		$update = true;
		$rec = mysqli_query($db, "SELECT * FROM editcdrom WHERE id=$id");
...
<!--data-->
<div class="data"><br>
<a href="tajukcdrom.php" class="edit_btn" >Edit Soalan Masalah cdrom</a>
<!---------------PHP code-------------->
...
<?php endif ?>
<!-----------end of PHP code----------->
<p><b>Masalah CD Rom tidak berfungsi (tidak dapat membaca cd)</b></p>
...
<table>
	...
	<?php  while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="cdrom_admin.php?edit3=<?php echo $row['id']; ?>" class="edit_btn" >Ubah Suai</a>
			</td>
			<td>
				<a href="bantuan_admin.php?del3=<?php echo $row['id']; ?>" class="del_btn">Buang</a>
			</td>
		</tr>
	<?php  } ?>
</table>
...
<form method="post" action="bantuan_admin.php" >
	...
	<div class="input-group">
		...
		<?php if ($update == false): ?>
			<button class="btn" type="submit" name="save3" style="background: #556B2F;" >Simpan</button>
		<?php else: ?>
			<button class="btn" type="submit" name="update3" >Kemaskini</button>
		<?php endif ?>
	</div>
</form>
<div class="btn_back">
