...
<body>
		...
		<br />
			<center>
			<button class="print_btn" onclick="printDiv()"><img src="images/Printer.ico" width="35" height="30"></button>
			<button><a href="admin.php">back</button>
			</center>
			...
			<?php $results = mysqli_query($db, "SELECT * FROM logpelapor"); ?>
				<table bgcolor="white" table-layout="fixed" width="90%" method="post" action="print.php">
					<thead>
						<tr><th>No</th>
							<th>Tarikh</th>
							<th>Masa</th>
					...
					<?php while ($row = mysqli_fetch_array($results)) { ?>
						<tr><td><?php echo $row['id']; ?></td>
							...
							<td><input type="checkbox" name='lang[]' value="selesai">Selesai</td>
							<td><input type="checkbox" name='lang[]' value="dalam pemerhatian">Dalam Pemerhatian</td>
							</tr>
						<?php } ?>
				</table>
			</div>
