...
<div class="div2">
	<a href="faq.php"><i class="fa fa-file fa-2x"></i>  Penyelesaian Masalah Yang Sering Berlaku (FAQ)</a><br><br>
	<a href="email.php"><i class="fa fa-file fa-2x"></i>  Emel dan Telefon Pegawai IT Department</a><br><br>
</div>
</body>
</html>
